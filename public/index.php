...
require_once '../actions/user_action.php';
...
if (isset($_GET['action'])) {
    ...
    switch ($action) {
        ...
        case 'add_member':
            ...
            add_member($conn,$name, $gender,  $birth,$address, $phone_number, $member_type, $join_date);

            break;
        case 'delete_member':
            $id = $_GET['id'];
            delete_member($conn, $id);
        case 'login':
            login();
            break;
        default:
            // cek dulu apakah admin sudah login atau belum
